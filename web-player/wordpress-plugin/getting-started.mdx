...
:::info
Blue clients will work out of the box, green clients will need some [additional configuration](/podlove-web-player/wordpress-plugin/subscribe-button#podcast-services).
:::
