...
This option is provided directly by WordPress. The application password is directly assigned to a user and can not use for an
...
Wordpress Administartoren können für jeden Benutzer Application Passwords anlegen, Benutzer können für ihren Account ebenfalls Application Passwords
anlegen. Der Zugang erfolgt über die Benutzerprofilseite.
