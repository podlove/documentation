...
An authorized user must have the right to modify posts in order to modify or query data. Here, the possibilities for authentication with the Wordpress 
...
application. If a client application was compromised, the user can revoke the password specifically for this application.
